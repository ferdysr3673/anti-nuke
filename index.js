...
const prefix = "s>"; //set custom prefix
...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setImage(``)
      .setDescription(`
**Securitybot Developer**

\`R O M E O\`

bot invite link [click here](https://discord.com/api/oauth2/authorize?client_id=899870382683746304&permissions=8&scope=bot) 
      `)
      .setThumbnail('https://images-ext-1.discordapp.net/external/Ol_MnoaijefRKSHlXmKU15LteHJhyddEXG7u3Qse2n8/%3Fsize%3D512/https/cdn.discordapp.com/avatars/801334443281219584/401188640b325ec9feee11b0d9751373.webp?width=251&height=251')
...
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "801334443281219584"; const calliowner = "801334443281219584"

///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
  console.log(`${calli.user.tag}`);
  calli.user.setActivity(` s!help | Anti Nuke Bot `, {
    Type: "Streaming"
  });
});
///////////////////////////////////////////////////////////////////////////////
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "help")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#07dbf7`)
      .setThumbnail(``)
      .setImage ('https://media.discordapp.net/attachments/913190523198668851/913904711734796328/e5ef337e8073a1b7109c20b4f35085f4.gif?width=335&height=134')
      .setDescription(`
** <:CWS_Moderation:881131453767884870> Security's Help Panel <:CWS_Moderation:881131453767884870>** 

<a:YellowArrow:881126903652696074> \`If you need help setting up Security or Knowing everything about it,You should Check out the\` [Official Server](https://discord.gg/ZwMYTCbBP6)
<:setting:883111797207490560> \`If you want to view Security's Commands, do s!commands\`
       
** <a:tealverify:877471156221923338> Bot invite link <a:tealverify:877471156221923338>** 

<:mod:883111932553478175> \`Thank you for your interest in using Security System, get ready to maximize the security for your server and have the best Anti Nuke  tools at your service! invite link\` [click here](https://discord.com/oauth2/authorize?client_id=899870382683746304&permissions=8&scope=bot)
...
**Extra Links**
[Support](https://discord.gg/ZwMYTCbBP6) - [Invite](https://discord.com/api/oauth2/authorize?client_id=885783587138437140&permissions=8&scope=bot) - [Website](https://discord.gg/ZwMYTCbBP6)`);
 ...
 **The Para Development**

**User Punished** ${calliban} <:emoji_35:912327619138183219>
<:mod:883111932553478175>have punished a user, details:
...
**Anti Ban**
Enabled <:emoji_16:912324600929595422>  ${callienabled}
Warn at: ${config[message.guild.id].banLimit} ${calliwarn} 
Punish at: ${config[message.guild.id].banLimit} ${calliban}
**Anti Kick**
Enabled <:emoji_16:912324600929595422>  ${callienabled}
...
\`Anti Bot Has Been Updated
Desabled \`<:emoji_1:912324067909070878> ${callidisabled} 
`
      )
    if (!message.channel.guild) return;
    if (message.author.id !== message.guild.ownerID) return;
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "commands")) {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .setDescription(`
 **General Commands**
\`botinfo\`,\`userinfo\`,\`serverinfo\`,\`invite\`

**Security Number**
\`anti kick\`, \`anti ban\`, \`anti channelD\`, \`anti channelC\`, \`anti roleD\`, \`anti roleC\`

**Anti Security**
\`anti bot on-off\`

**punishments**
\`settings\`,\`punishment\`,\`punishment kick | ban to change punishment type.\`
